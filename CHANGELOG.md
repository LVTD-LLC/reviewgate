...
- Post visible findings that cannot be anchored inline as separate deduped PR conversation comments, keeping the canonical summary focused on score and status.
