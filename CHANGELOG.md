...
- Preserved an already-reconciled mixed open/fixed finding set during canonical summary publication instead of applying the same model dispositions twice; genuinely late agent dispositions still reconcile before publication.
