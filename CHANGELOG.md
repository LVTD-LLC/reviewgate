...
- Revalidated disposition authors through GitHub's repository-permission endpoint when workflow-token status filtering hides a valid human-created receipt, while retaining exact status receipts as an independent writer attestation.
