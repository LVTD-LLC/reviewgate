...
- Added sanitized PR #365 recall fixtures for unavailable runner tooling and stale release assertions, made the full deterministic dogfood regression suite block runtime releases before compilation and publication, and restored automatic ReviewGate dogfooding on repository pull requests.
