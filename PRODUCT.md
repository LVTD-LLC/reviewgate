...
Review Gate is a free, fully open-source credibility project. The initial goal is adoption and trust among AI builders, open-source maintainers, solo builders, and small teams, not paid conversion.
...
Do not position Review Gate as a generic open-source PR reviewer. The sharper wedge is score-gated review for agent-written PRs: score, rubric, canonical summary, check-run status, machine-readable findings, and agent-loop compatibility.
